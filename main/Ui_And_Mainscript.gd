...
func _process(_delta: float):
	...
	XpLabel.global_position = RigidBody.global_position + offsetXP
	MoneyLabel.global_position = RigidBody.global_position + offsetMoney
	PrestigeLabel.global_position = RigidBody.global_position + offsetPrestige
